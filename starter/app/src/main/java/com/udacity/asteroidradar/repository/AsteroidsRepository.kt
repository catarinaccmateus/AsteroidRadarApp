...
class AsteroidsRepository(private val database: AsteroidsDatabase) {
    ...
    /** API Request Status */
    lateinit var apiStatus: MutableLiveData<AsteroidApiStatus>
    ...
    suspend fun refreshAsteroids() {
        withContext(Dispatchers.IO) {
            apiStatus.value = AsteroidApiStatus.LOADING
            try {
                ...
                apiStatus.value = AsteroidApiStatus.DONE
            } catch (e: Exception) {
                apiStatus.value = AsteroidApiStatus.ERROR
                e.printStackTrace()
            }
